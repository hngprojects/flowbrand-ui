    ...
    <div className="flex items-start gap-3 py-1">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="shrink-0 text-sm text-gray-subtle">
            {statusLabel(item)}
          </span>
        </div>
      ...
      <button
        ...
        className="mt-0.5 shrink-0 text-gray-outline transition-colors hover:text-gray-subtle"
  ...
  return (
    <main className="flex flex-1 flex-col">
      <div className="mx-auto flex w-full max-w-[640px] flex-col items-center px-4 py-10 md:py-14">
        <h1 className="mb-2 text-center text-2xl-plus font-semibold leading-tight tracking-tight text-main md:text-4xl ">
          Start creating your marketing strategy
        </h1>
        <p className="mb-8 max-w-md text-center text-sm text-gray-subtle md:mb-10 md:text-md-accent">
          Create marketing strategy tailored to your business needs.
        </p>

        <div className="w-full rounded-2xl border border-black-25 bg-white p-5 shadow-[0px_4px_24px_rgba(16,24,40,0.06)] md:p-8">
          <WideDashedBorder active={dragging}>
            <div
              ...
              className={cn(
                ...
                dragging ? "bg-primary-55" : "bg-white hover:bg-gray-35",
              )}
            >
              <input
                ref={inputRef}
              ...
              <Image
                ...
                priority
              />
              <p className="text-center text-md-accent font-semibold text-main md:text-base">
              ...
              <p className="mt-1.5 text-center text-xs text-gray-hint md:text-sm-accent">
          ...
          <button
            ...
            className={cn(
              ...
              allDone && !isGenerating
                ...
                : "cursor-not-allowed bg-primary-75 text-primary-500",
            )}
          >
          ...
          <button
            ...
            className="mt-4 flex w-full cursor-pointer items-center justify-center gap-0.5 text-sm text-gray-subtle transition-colors hover:text-gray-dark"
          >
            Don&apos;t know what to do? Click here
            <ChevronRight size={16} className="text-gray-hint" />
          </button>
        </div>
        ...
        <button
          ...
          onClick={goToQuestions}
          className={cn(
            "mt-5 flex w-full cursor-pointer items-center gap-4 rounded-2xl border border-black-25 bg-white px-5 py-5",
            "shadow-[0px_4px_24px_rgba(16,24,40,0.06)] transition-colors hover:bg-gray-35",
          )}
        >
          <Image
          ...
          <div className="min-w-0 flex-1 text-left">
            <p className="text-md-accent font-semibold leading-snug text-main">
              Don&apos;t have a document to upload? Create your strategy another
              way.
            </p>
            <p className="mt-1 text-sm text-gray-subtle">
              Create your marketing strategy without the need to upload a
              document.
            </p>
          </div>
          <ChevronRight size={20} className="shrink-0 text-gray-hint" />
        </button>
      </div>
    </main>
  );
