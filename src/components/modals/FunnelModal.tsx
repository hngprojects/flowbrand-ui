        ...
        >
          <div className="flex items-center justify-between mb-6 shrink-0 border-b-3 border-gray-500 pb-4 mx-[-32px] px-8">
            ...
            <button
              ...
              text-sm text-dark-deep transition-colors pointer-events-auto hover:bg-gray-50 cursor-pointer"
            >
              <svg
                width="20"
                height="20"
          ...
          <TabsList
            className="flex items-center w-full h-[38px] gap-[10px] mb-6 shrink-0 rounded-[12px] border border-gray-500 
          ...
          >
            {tabs.map((tab) => (
              <TabsTrigger
                ...
                text-base leading-[150%] text-black-300  data-active:bg-primary-500 data-active:text-white cursor-pointer border-0 
