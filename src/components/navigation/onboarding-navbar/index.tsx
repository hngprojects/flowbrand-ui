...
const OnboardingNavbar = ({
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 border-b border-black-25 bg-white/90 backdrop-blur-md px-4">
        <div className="dashboard-layout-class flex h-[72px] items-center justify-between md:h-[83px]">
          <div className="flex items-center gap-2 md:gap-3">
            {showMenuButton && (
              <button
                className="flex h-10 w-10 items-center justify-center rounded-full border border-black-25 lg:hidden"
                onClick={() => {
                  if (isStrategyRoute) {
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-black-25 md:h-11 md:w-11"
            >
              <BellIcon />
            </button>
            ...
            <button
              ...
              className="flex h-10 items-center gap-2 rounded-full border border-black-25 px-2.5 py-2 md:h-11 md:gap-[10px] md:px-3 md:py-[10px] lg:w-[103px]"
            >
              <ProfileIcon />
              <span className="hidden text-sm font-medium text-main lg:inline">
                Profile
              </span>
            </button>
          </div>
      ...
      {isStrategyRoute && (
        <>
          ...
          >
            <div className="flex items-center justify-between border-b border-black-25 px-4 py-4">
              <Link href="/dashboard" className="cursor-pointer">
                <LogoIcon />
              </Link>
              <button
                type="button"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-black-25"
                onClick={() => setDrawerPath(null)}
