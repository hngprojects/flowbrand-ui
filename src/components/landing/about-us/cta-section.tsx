      ...
      <div className="section-class max-w-5xl flex flex-col justify-center md:gap-[1rem] mx-auto">
        ...
        >
          ...
          >
            <Link
              href="/signup"
              className="bg-[var(--primary)] text-white relative inline-flex px-[2rem] py-[0.69rem] text-[1rem] font-medium focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-inset f
            >
              <motion.span
