  ...
  return (
    <section className="w-full bg-[#FCF4E8]">
      <div className="section-class max-w-5xl flex flex-col items-center py-30 text-center">
        <motion.span
          className="mb-5 text-[11px] font-semibold tracking-[1.6px] text-black uppercase"
        ...
        <motion.h2
          className="text-[22px] leading-[1.4] font-normal tracking-[-0.2px] text-black italic md:text-[32px] lg:text-[40px]"
