  ...
  return (
    <section className="w-full bg-accent-50">
      <div className="section-class max-w-5xl flex flex-col items-center py-30 text-center">
        <motion.span
          className="mb-5 text-base font-semibold tracking-[1.6px] text-black uppercase"
        ...
        <motion.h2
          className="text-2xl leading-[1.4] font-normal tracking-[-0.2px] text-black lg:text-5xl "
