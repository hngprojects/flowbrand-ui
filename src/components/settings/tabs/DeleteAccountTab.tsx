  ...
  return (
    <>
      <div className="flex flex-col gap-6">
        <h3 className="text-xl font-medium text-black-300 ">Delete Account</h3>
        ...
        <h4 className="text-base font-medium text-brand-deep ">
          What will happen:
        </h4>
        <div className="flex flex-col gap-4 rounded-[12px] border border-gray-200 px-4 py-6">
          <ul className="grid grid-cols-1 gap-3 md:grid-cols-2">
            {consequences.map((item) => (
              <li
                key={item}
                className="flex items-start gap-2 text-sm text-brand-deep "
              >
      ...
      <BaseModal isOpen={confirmOpen} onClose={() => setConfirmOpen(false)}>
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-4xl  font-medium text-foreground leading-[120%]">
              Delete account
            </h2>
